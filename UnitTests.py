...
class TestGameAspects(unittest.TestCase):
    ...
    def test_phase2_initiated(self, ):
        self.assertEqual(self.main.p1.placedPieces, 9, 'Player 1 has placed all nine pieces')
        self.assertEqual(self.main.p2.placedPieces, 9, 'Player 2 has placed all nine pieces')
